    ...
    <div className="max-w-4xl mx-auto px-4 py-16">
      ...
      <div className="flex flex-col md:flex-row gap-10 items-start mb-14">
        ...
        <div className="flex-1 leading-relaxed space-y-4 text-[var(--color-fg)]">
          ...
          <p>
            לבסוף, בשנת 2024, רכשתי את הוצאת רסיס נהרה, ההוצאה בה פירסמתי את ספרי הראשון (<em>אימפריה</em>, 2010). כיום רסיס נהרה מבית שלומית גיא היא הוצאת בוטיק המתמחה בספרי ספורט וילדים, וקטלוג ההוצאה כולל אחד עשר ספרים פורצי דרך ומיוחדים — מחקר, עיון וספרות ילדים.{" "}
